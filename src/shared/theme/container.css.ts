...
const responsiveProperties = defineProperties({
  ...
  properties: {
    ...
    width: { ...commonSizes, ...tokensConfig.space, viewport: '100dvw' },
    height: { ...commonSizes, ...tokensConfig.space, viewport: '100dvh' },
    maxWidth: { ...commonSizes, ...tokensConfig.space, viewport: '100dvw' },
    maxHeight: { ...commonSizes, ...tokensConfig.space, viewport: '100dvh' },
    minWidth: { ...commonSizes, ...tokensConfig.space, viewport: '100dvw' },
    minHeight: { ...commonSizes, ...tokensConfig.space, viewport: '100dvh' },
